...
module.exports = {
    ...
    */
    ...
    async run(client, interaction, option) {
        ...
        const player2 = option[0].user;
        const time = 60;
        const TieVotetime = 30;
        const DelayTieTime = 60;
        if (player2.bot) return interaction.reply({content: "Bạn không thể chơi cùng với máy", ephemeral:true})
        if (player2.id === player1.id) return interaction.reply({content: "Bạn không thể chơi với chính mình", ephemeral:true})
        var board = [
            ["⚪", "⚪", "⚪", "⚪", "⚪", "⚪", "⚪"],
            ["⚪", "⚪", "⚪", "⚪", "⚪", "⚪", "⚪"],
            ["⚪", "⚪", "⚪", "⚪", "⚪", "⚪", "⚪"],
